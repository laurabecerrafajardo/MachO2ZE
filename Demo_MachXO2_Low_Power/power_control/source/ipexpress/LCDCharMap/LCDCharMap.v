...
/* Module Version: 5.0 */
/* C:\Diamond\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 00 -rp 1100 -addr_width 8 -data_width 7 -num_rows 256 -outdata REGISTERED -cascade -1 -resetmode SYNC -sync_reset -memfile c:/documents and settings/cwest/desktop/machxo2_pico_demos/soc/demo_machxo2_pico_environment_scanning9/demo_machxo2_pico_environment_scanning/source/ipexpress/lcdcharmap.mem -memformat bin -e  */
...
module LCDCharMap (Address, OutClock, OutClockEn, Reset, Q);
    ...
    defparam LCDCharMap_0_0_0.GSR = "DISABLED" ;
