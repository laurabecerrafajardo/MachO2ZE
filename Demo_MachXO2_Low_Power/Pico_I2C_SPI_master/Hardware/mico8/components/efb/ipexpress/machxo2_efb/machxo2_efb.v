...
/* Module Version: 1.0 */
/* C:\lscc\diamond\1.4\ispfpga\bin\nt\scuba.exe -w -n machxo2_efb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 12 -i2c1 -i2c1_freq 100 -i2c1_sa 0001001 -i2c1_addr 7 -spi -spi_mode Both -spi_freq 1 -spi_cs 1 -dev 1200 -e  */
/* Tue Mar 06 00:03:34 2012 */


`timescale 1 ns / 1 ps
module machxo2_efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, i2c1_scl, i2c1_sda, 
    i2c1_irqo, spi_clk, spi_miso, spi_mosi, spi_scsn, spi_csn);
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.SPI_CLK_DIVIDER = 12 ;
    ...
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .I2C2SDAO(), .I2C2SDAOEN(), .I2C1IRQO(i2c1_irqo), .I2C2IRQO(), .SPISCKO(spi_clk_o), 
