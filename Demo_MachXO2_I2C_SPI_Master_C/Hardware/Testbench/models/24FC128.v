// *******************************************************************************************************
// **                                                                                                   **
// **   24FC128.v - Microchip 24FC128 128K-BIT I2C SERIAL EEPROM (VCC = +1.7V TO +5.5V)                 **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M24FC128 (A0, A1, A2, WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   reg  [07:00]         MemoryBlock [0:16383];          // EEPROM data memory array
...
// *******************************************************************************************************
   ...
   initial begin
      ...
      `else
         tAA = 400;                 // SCL to SDA output delay
         //tWC = 5000000;             // memory write cycle time
         tWC = 50000;             // JJM: reduce to 50usec for faster simulation - memory write cycle time
      `endif
      `endif
   end
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge WriteActive) begin
      for (LoopIndex = 0; LoopIndex < WrCounter; LoopIndex = LoopIndex + 1) begin
         ...
         MemoryBlock[{StartAddress[13:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
      end
   end
...
// -------------------------------------------------------------------------------------------------------
   ...
   assign RdDataByte = MemoryBlock[RdPointer[13:00]];
